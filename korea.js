...
function drawMap(target) {
  ...
  var projection = d3.geo.mercator().scale(initialScale).translate([initialX, initialY]);
  ...
  function translateTolabel(d) {
    ...
    if (d.properties.code == 31) {
      ...
      //충남은 조금 더 내리기
      arr[1] += d3.event && d3.event.scale ? d3.event.scale / height + 10 : initialScale / height + 10;
    }
